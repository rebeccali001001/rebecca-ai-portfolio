(function () {
  ...
  const pythonSyntaxSlugs = ['python-summary','python-overview','python-basics','data-types','collections','operators','conditions','loops','python-functions','strings','modules-imports','indexing-slicing','comprehensions','files','exceptions','classes-objects','iterators-generators','json','api-requests','paths-os','virtual-environments','useful-standard-libraries'];
  ...
  function renderKnowledgeSidebar(target, type) {
    ...
    const sqlStructure = window.SQL_STRUCTURE || [
      {id:'01',title:'Query Basics',page:'sql-query-basics.html'},
      {id:'02',title:'Filtering & Conditions',page:'sql-filtering-conditions.html'},
      {id:'03',title:'Sorting & Aggregation',page:'sql-sorting-aggregation.html'},
      {id:'04',title:'Joining & Combining Data',page:'sql-joining-combining.html'},
      {id:'05',title:'Expressions & Functions',page:'sql-expressions-functions.html'},
      {id:'06',title:'Subqueries & Advanced Queries',page:'sql-advanced-queries.html'},
      {id:'07',title:'Data Modification',page:'sql-data-modification.html'},
      {id:'08',title:'Database Structure',page:'sql-database-structure.html'},
      {id:'09',title:'SQL Patterns & Reference',page:'sql-patterns-reference.html'}
    ];
    const sqlNavigation = ['Summary', ...sqlStructure.map((module) => `${module.id} · ${module.title}`)];
    const syntax = {Python:['Summary','Glossary','Overview','01 · Python Basics','02 · Data Types','03 · Collections','04 · Operators','05 · Conditions','06 · Loops','07 · Functions','08 · Strings','09 · Modules & Imports','10 · Indexing & Slicing','11 · Comprehensions','12 · Files','13 · Exceptions','14 · Classes & Objects','15 · Iterators & Generators','16 · JSON & CSV','17 · API Requests','18 · Paths & OS','19 · Virtual Environments & pip','20 · Useful Standard Libraries'],SQL:sqlNavigation,Web:['Summary','Overview','__html__'],HTML:['HTML Summary','Overview','01 · Document Structure','02 · Elements & Tags','03 · Attributes','04 · Text & Headings','05 · Links','06 · Images & Media','07 · Lists','08 · Tables','09 · Forms','10 · Semantic HTML','11 · Metadata & Head','12 · IDs & Classes','13 · Data Attributes','14 · Accessibility','15 · HTML Entities'],CSS:['Overview','01 · Selectors','02 · Cascade & Specificity','03 · Box Model','04 · Units','05 · Colors & Backgrounds','06 · Typography','07 · Display','08 · Position','09 · Flexbox','10 · Grid','11 · Spacing & Sizing','12 · Borders & Shadows','13 · Pseudo Classes','14 · Pseudo Elements','15 · Responsive Design','16 · Media Queries','17 · Transitions','18 · Animations','19 · CSS Variables','20 · Functions','21 · Overflow & Z-index','Summary']};
    ...
    const item = (label, moduleName) => {
      ...
      const syntaxPages = {
        ...
        'Glossary': moduleName === 'Python' ? 'python-glossary.html' : null,
        ...
        '01 · Python Basics':'python-basics.html', '02 · Data Types':'data-types.html', '03 · Collections':'collections.html', '04 · Operators':'operators.html', '05 · Conditions':'conditions.html', '06 · Loops':'loops.html', '07 · Functions':'python-functions.html', '08 · Strings':'strings.html', '09 · Modules & Imports':'modules-imports.html', '10 · Indexing & Slicing':'indexing-slicing.html', '11 · Comprehensions':'comprehensions.html', '12 · Files':'files.html', '13 · Exceptions':'exceptions.html', '14 · Classes & Objects':'classes-objects.html', '15 · Iterators & Generators':'iterators-generators.html', '16 · JSON & CSV':'json.html', '17 · API Requests':'api-requests.html', '18 · Paths & OS':'paths-os.html', '19 · Virtual Environments & pip':'virtual-environments.html', '20 · Useful Standard Libraries':'useful-standard-libraries.html',
      ...
      return `<li>${unavailableModule08Topic ? `<span>${label}</span>` : `<a href="${contextualHref}" class="${contextActive ? 'active' : ''}"${contextActive ? ' aria-current="page"' : ''}>${label}</a>`}</li>`;
    };
    const group = (name, items) => {
      ...
      const isSqlSyntaxPage = pathname.endsWith('/sql.html') || pathname.endsWith('/sql-summary.html') || pathname.includes('/sql-');
      const shouldOpen = type === 'syntax' && ((name === 'Python' && isPythonSyntaxPage) || (name === 'SQL' && isSqlSyntaxPage));
      return `<details${shouldOpen ? ' open' : ''}><summary>${name}</summary><ul>${displayItems.map((label) => {
